<center><form name="logForm" method="post" action="?open=Login-Validasi">
  <table class="table-list" width="500" border="0" cellpadding="2" cellspacing="1" bgcolor="#999999">
    <tr>
      ...
      <th colspan="2" bgcolor="#CCCCCC"><strong>INICIAR SESION</strong></td>      </tr>
    <tr>
      <td width="117" bgcolor="#FFFFFF"><strong>USUARIO</strong></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input type="submit" name="btnLogin" value="INGRESAR" /></td>
    </tr>
  </table>
</form></center>
